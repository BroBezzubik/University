...
class MainWindow(QWidget):
    ...
    def on_pushButton_clicked(self):
        ...
        u.le_cid0_wt.setText('{:.2f}'.format(devices[3].max_waiting_time))
        u.le_cid1_wt.setText('{:.2f}'.format(devices[4].max_waiting_time))
        u.le_cid2_wt.setText('{:.2f}'.format(devices[5].max_waiting_time))
        u.le_cid3_wt.setText('{:.2f}'.format(devices[6].max_waiting_time))
        u.le_pcd0_wt.setText('{:.2f}'.format(devices[7].max_waiting_time))
        u.le_cc0_wt.setText('{:.2f}'.format(devices[8].max_waiting_time))
    ...
    def start_modelling(self, pg0_m, pg1_m, pg0_d, pg1_d,
        ...
        devices = passengers + entrance + checkin + customs_control + passport_control + (plane,)
